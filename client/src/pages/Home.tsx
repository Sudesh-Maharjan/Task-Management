...
const Home: React.FC = () => {
  ...
  const fetchTasks = () => {
    axios
      .get<Task[]>("http://localhost:8000/api/v1/tasks", {
        headers: {
  ...
  const handleUpdateTask = (id: string) => {
    axios
      .put(`http://localhost:8000/api/v1/tasks/${id}`, selectedTask, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
      ...
      <div className="container mx-auto my-14">
              ...
              <div className="bg-purple-100 border border-purple-300 rounded-md p-4">
                ...
                <div className="flex justify-end mt-4">
                  <button
                    ...
                    className="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-md mr-2 focus:outline-none focus:ring-2 focus:ring-purple-400"
                  >
                    <MdBrowserUpdated />
                  </button>
                  <button
                    onClick={() => handleDeleteTask(task._id)}
                    className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-red-400"
                  >
                    <MdDelete />
                  </button>
                </div>
          ...
          <div className="fixed inset-0 z-50 bg-black bg-opacity-50 transition-opacity duration-500">
            <div className="absolute top-0 right-0 h-full bg-purple-100 border-l border-purple-300 w-96 p-4 transform transition-transform ease-in-out duration-500">
              ...
              <textarea
                ...
                value={
                  selectedTask ? selectedTask.description : newTask.description
                }
                onChange={(e) =>
                  setSelectedTask(
                    selectedTask
              ...
              <button
                ...
                className="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-400"
              >
        ...
        {!showCreateForm && (
          <button
            ...
            className="fixed bottom-4 right-4 bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-purple-400 transition-all duration-500"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
